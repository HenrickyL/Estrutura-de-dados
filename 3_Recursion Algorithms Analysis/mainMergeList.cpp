...
using namespace std;
//Global
const int tam[] = {1000,5000,10000,25000,50000,65000,85000,100000,200000};//,500000,1000000};
...
int main(){
	...
	//////ifstream arqIn;
 	...
 	arqOut.open("dadosMergeList.txt",ios::out); //escrita
...
//	verificações
	...
	if((double) timeFinal >= 60*60){
		...
		arqOut.open("Tempo totalMergeList.txt",ios::out);
		arqOut << timeFinal <<" h \n";
		arqOut.close(); 
